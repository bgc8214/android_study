...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 1929;
    private static final int ACTION_DRINK_WATER_INTENT_ID= 1292;
    /**
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                ...
                .addAction(ignoreReminderAction(context)).setAutoCancel(true);
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        NotificationCompat.Action ignoreAction = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px,
        "필요 없어요",pendingIntent);
        return ignoreAction;
    }
    ...
    public static final NotificationCompat.Action drinkWaterAction(Context context){
