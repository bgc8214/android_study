...
//      TODO (7) Generate a weather summary with the date, description, high and low
        ...
        String dateString = SunshineDateUtils.getFriendlyDateString(mContext,dateTime,false);
        int weather = mCursor.getInt(1);
        String desc = SunshineWeatherUtils.getStringForWeatherCondition(mContext,weather);
        double highCelsius = mCursor.getDouble(2);
        /* Read low temperature from the cursor (in degrees celsius) */
        double lowCelsius = mCursor.getDouble(3);
        String temperature = SunshineWeatherUtils.formatHighLows(mContext,highCelsius, lowCelsius);
        String weatherSummary = dateString + "-"+desc+"-"+temperature;
