...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, android.support.v4.app.LoaderManager.LoaderCallbacks<String[]> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.support.v4.app.LoaderManager.LoaderCallbacks callback = MainActivity.this;
        Bundle bundle = null;
        ...
        return new android.support.v4.content.AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                try{
                    ...
                    String[] jsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,jsonWeatherRes);
