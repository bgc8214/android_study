...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return sharedPreferences.getString(key, location);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String unit = context.getString(R.string.pref_units_metric);
        String preferUnits = sharedPreferences.getString(key, unit);
