...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int SYNC_FLEX_SECOND = SYNC_INTERVAL_SECONDS/3;
...
//  TODO (12) Create a method to schedule our periodic weather sync
    static void jobDispatcherSync(@NonNull final Context context){
        Driver driver = new GooglePlayDriver(context);
        FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(driver);
        Job job  = dispatcher.newJobBuilder().setService(SunshineFirebaseJobService.class)
                .setTag(SYNC_TAG)
                .setConstraints(Constraint.ON_ANY_NETWORK)
                .setLifetime(Lifetime.FOREVER)
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(SYNC_INTERVAL_SECONDS,SYNC_FLEX_SECOND+SYNC_FLEX_SECOND))
