...
public final class SunshinePreferences {
    ...
    public static boolean notiEnabled(Context context){
        String notiKey = context.getString(R.string.pref_enable_notifications_key);

        boolean showDisplay = context.getResources().getBoolean(R.bool.show_default);

        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);

        boolean shouldShowNoti = sp.getBoolean(notiKey,showDisplay);

        return shouldShowNoti;
    }
}